...
HBAT <- read.spss("G:\\My Drive\\0. Multivariate - TA\\Lab docs\\2. Logistic Regression\\HBAT.sav", 
                 use.value.labels=F, to.data.frame=TRUE)

HBAT_SPLITS <- read.spss("G:\\My Drive\\0. Multivariate - TA\\Lab docs\\2. Logistic Regression\\HBAT_SPLITS.sav", 
                         use.value.labels=F, to.data.frame=TRUE)
